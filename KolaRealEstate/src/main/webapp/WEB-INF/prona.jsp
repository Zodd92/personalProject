...
<form:form>
  <form:forEach var="realEstate" items="realEstates"></form:forEach>
  <div>
    <img src="/Fizzbuzz/images.png" alt="photo">
    <img src="/Fizzbuzz/bed.png" alt="photo"><span>"${realEstate.room}"</span>
    <img src="/Fizzbuzz/banjo.png" alt="photo"><span>"${realEstate.toilet}"</span>
